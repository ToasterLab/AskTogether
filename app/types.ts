...
export type FeaturedOrganisationsArgs = {
...
export type UpdateFeaturedInput = {
  data?: InputMaybe<EditFeaturedInput>;
};
...
export type MutationUpdateFeaturedArgs = {
  input?: InputMaybe<UpdateFeaturedInput>;
};
